...
| 区分 | 収録数 | 初版目標 |
|---|---|---|
| 芸人・コンビ・グループ | 227 組 | 80（可能なら100+） |
| 落語家 | 34 名 | 12 |
| 番組・配信コンテンツ | 34 件 | 30 |
| 公式/正当な動画・チャンネルリンク | 約125 件 | 60 |

（芸人227 + 落語家34 = 261 エンティティ。初版は芸人100＋落語家18で公開し、その後 昭和〜令和のレジェンド・KOC/R-1/THE SECOND勢・上方ベテラン・モノマネ/音楽ネタ・ピン芸・上方落語家などを +143 追加。動画リンクは各エントリの公式YouTubeチャンネル＋番組の公式動画/配信＋公式チャンネル一覧の合計。追加分もすべて実在・公式情報を検証したもののみで、確認できないURLは掲載していない。）
