...
| 区分 | 収録数 | 初版目標 |
|---|---|---|
| 芸人・コンビ・グループ | 290 組 | 80（可能なら100+） |
| 落語家 | 52 名 | 12 |
| 番組・配信コンテンツ | 34 件 | 30 |
| 公式/正当な動画・チャンネルリンク | 約160 件 | 60 |

（芸人290 + 落語家52 = 342 エンティティ。初版118から、並列リサーチ2巡で +224 追加(昭和〜令和のレジェンド、M-1/KOC/R-1/THE W/THE SECOND勢、上方・江戸の落語家、モノマネ/音楽ネタ/ピン芸、女性芸人、吉本新喜劇 等)。動画リンクは各エントリの公式YouTubeチャンネル＋番組の公式動画/配信＋公式チャンネル一覧の合計。追加分もすべて実在・公式情報を検証したもののみで、確認できないURLは掲載していない。）
